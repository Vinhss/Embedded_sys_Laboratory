...
void Timer3_Init(void)
{
	LPC_SC->PCONP |= (1<<23);      // turn on Timer1 module
	LPC_SC->PCLKSEL1 &= ~(0x3<<15);//0b010000;systemcore clock/4= 100MHz/4=25MHz
	
	LPC_TIM3->PR = PRESCALE; // 25 000 000Hz / 100 000 = 250Hz => T=1/250=4ms
	LPC_TIM3->TCR = 0x02;
}
